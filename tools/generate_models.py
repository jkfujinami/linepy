...
class ThriftParser:
    ...
    def generate_code(self, root_service: Optional[str] = None) -> str:
        ...
        # `linepy._model_base.ModelBase` -- NOT pydantic. pydantic-core (a
        ...
        # linepy/_model_base.py for the full rationale.
        lines = []
        ...
        lines.append("from .._model_base import ModelBase, model_field")
        lines.append("")
