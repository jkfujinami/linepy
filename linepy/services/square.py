...
class SquareService(ServiceBase):
    ...
    def createSquare(
        ...
        profileImageObsHash: str = (
            "0h6tJf0hQsaVt3H0eLAsAWDFheczgHd3wTCTx2eApNKSoefHNVGRdwfgxbdgU"
            "MLi8MSngnPFMeNmpbLi8MSngnPFMeNmpbLi8MSngnOA"
        ),
    ...
    def createSquareChatThread(
        ...
        Example:
            `cl.createSquareChatThread("mxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    ...
    def syncSquareMembers(
        ...
        Example:
            `cl.syncSquareMembers("sxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
                                  {'pxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx': 0})`
